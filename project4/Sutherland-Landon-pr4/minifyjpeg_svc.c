...
int
_minify_jpeg_1 (jpeg  *argp, void *result, struct svc_req *rqstp)
{
	return (minify_jpeg_1_svc(*argp, result, rqstp));
}
...
{
	union {
		jpeg minify_jpeg_1_arg;
	} argument;
	union {
		jpeg minify_jpeg_1_res;
	} result;
	bool_t retval;
	...
	case MINIFY_JPEG:
		_xdr_argument = (xdrproc_t) xdr_jpeg;
		_xdr_result = (xdrproc_t) xdr_jpeg;
		local = (bool_t (*) (char *, void *,  struct svc_req *))_minify_jpeg_1;
		break;
